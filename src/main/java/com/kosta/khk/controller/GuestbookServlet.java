...
import com.kosta.khk.dao.GuestbookDao;
import com.kosta.khk.dao.GuestbookDaoImpl;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("add".equals(actionName)) {
			...
			if(count > 0){
				...
				RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/guestbook/deleteError.jsp");
				rd.forward(request, response);
			}
		} else {
			GuestbookDao dao = new GuestbookDaoImpl();
